				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						...
						<div class="form-inline">
							...
							{!! Form::text('health_facility', old('health_facility'), array('class' => 'form-control col-sm-4 text-line')) !!}
							...
							{!! Form::select('facility_district',[""=>""]+$districts,'',['id'=>'facility_district', 'class'=>'form-control col-sm-4', 'style' =>'width:195px']) !!}
					...
					<div class="form-inline">
						...
						{!! Form::select('patient_district',[""=>""]+$districts,'',['id'=>'patient_district', 'class'=>'form-control', 'style' =>'width:195px']) !!}
					</div> <br><br>
					...
					<div class="form-inline">
						...
						<select style="width: 20%;" name="symptoms[]" multiple>
						...
						<div>
							{!! Form::label('symptoms', 'Other signs:', array('class' =>'col-md-2')) !!}
							<input type="text" name="otherSymp" id="otherSymp" class="form-control input-sm" size="25" placeholder="Other symptoms...">
							<div>
						<div>
						</div><br><br>
						...
						<div class="panel panel-default">
							<div class="panel-body">
								...
								<div class="form-inline" id="chinaTravel" style="display:none;">
									...
									{!! Form::text('travelDateToChina', old('travelDateToChina'), array('class' => 'form-control col-sm-4  standard-datepicker-nofuture text-line')) !!} <br><br>

									{!! Form::label('travelDateFromChina', 'ii) Date 	traveled from China or other country affected by 2019-nCoV?', array('class' =>'col-md-7')) !!}
									{!! Form::text('travelDateFromChina', old('travelDateFromChina'), array('class' => 'form-control col-sm-4  standard-datepicker-nofuture text-line')) !!} <br><br>

									{!! Form::label('stateVisited', 'State / Country / City visited', array('class' =>'col-md-7')) !!}
									{!! Form::text('stateVisited', old('stateVisited'), array('class' => 'form-control col-sm-4  text-line')) !!} <br><br>

									{!! Form::label('UgArrivalDate', 'iii) Date Arrived in Uganda', array('class' =>'col-md-7')) !!}
									{!! Form::text('UgArrivalDate', old('UgArrivalDate'), array('class' => 'form-control col-sm-4  standard-datepicker-nofuture text-line')) !!}
								</div>
								</div>
						...
						<div class="form-inline">
							...
							<select style="width: 20%;" name="is_health_care_worker_being_tested">
								<option value="" selected="selected">Select...</option>
								<option value="1">Yes</option>
								<option value="0">No</option>
								<option value="3">Unknown</option>
						...
						<div class="form-inline">
							...
							<select style="width: 20%;" name="healthFacilityHistory">
								<option value="" selected="selected">Select...</option>
								<option value="1">Yes</option>
								<option value="0">No</option>
								<option value="3">Unknown</option>
						...
						<div class="form-inline">
							...
							<select style="width: 20%;" name="acuteRespiratory">
								<option value="" selected="selected">Select...</option>
								<option value="1">Yes</option>
								<option value="0">No</option>
								<option value="3">Unknown</option>
						...
						<div class="form-inline">
							...
							<select style="width: 20%;" name="additionalSigns[]" multiple>
							...
							<div>
								{!! Form::label('AdditionalSigns', 'Other additional signs and symptoms:', array('class' => 'col-md-2')) !!}
								<input type="text" name="otherAdditionalSign" id="otherAdditionalSign" class="form-control input-sm" size="30" placeholder="Other symptoms...">
							</div><br>

							<div class="form-inline">
								{!! Form::label('diagnosis', '10. Diagnosis (select all that apply):', array('class' => 'col-md-3')) !!}

								<select style="width: 20%;" name="diagnosis[]" multiple>
									<option value="" selected="selected"></option>
									<option value="Pneumonia-Clinical">Pneumonia-Clinical</option>
									<option value="Pneumonia-Radiologic">Pneumonia-Radiologic</option>
							...
							<div class="form-inline">
								...
								<select style="width: 20%;" name="comorbid[]" onchange="if (this.value=='Other'){this.form['otherCombid'].style.visibility='visible'}else {this.form['otherCombid'].style.visibility='hidden'};" multiple>
									<option value="" selected="selected"></option>
							...
							<div class="form-inline">
								...
								<select style="width: 20%;" name="admitted" onchange="if (this.value=='Yes'){this.form['admissionDate'].style.visibility='visible'}else {this.form['otherCombid'].style.visibility='hidden'};">
									<option value="" selected="selected">Select...</option>
									<option value="1">Yes</option>
									<option value="0">No</option>
								</select>
							...
							<div class="form-inline">
								...
								<select style="width: 20%;" name="patientDied" onchange="if (this.value=='Yes'){this.form['deathDate'].style.visibility='visible'}else {this.form['deathDate'].style.visibility='hidden'};">
									<option value="" selected="selected">Select...</option>
									<option value="1">Yes</option>
									<option value="0">No</option>
								</select>
							...
							<div class="form-inline">
								...
								<select style="width: 20%;" name="otherEtiology" onchange="if (this.value=='1'){this.form['otherEti'].style.visibility='visible'}else {this.form['otherEti'].style.visibility='hidden'};">
									<option value="" selected="selected">Select...</option>
									<option value="1">Yes</option>
									<option value="0">No</option>
				...
				<script>
					...
					$(document).ready(function(){
						...
						$(document).on('click', '.add', function(){
							...
							var html = '';
							html += '<tr>';
								html += '<td><select name ="specimen_type[]"> <option value=""></option><option value="NP swab">NP Swab</option><option value="OP swab">OP swab</option><option value="Sputum">Sputum</option><option value="BAL fluid">BAL fluid</option><option value="Trachial aspirate">Tracheal aspirate</option><option value="Stool">Stool</option><option value="Urine">Urine</option><option value="Serum">Serum</option></td>';
									html += '<td><input type="text" name="specimen_ulin[]" '+keyup+' class="form-control " id="specimen_ulin'+row_count+'" /></td>';
									html += '<td><input class="form-control standard-datepicker-nofuture" name="specimen_collection_date[]" type="text" ></td>';
									html += '<td><select name ="sentToUvri[]"> <option value=""></option><option value="Yes">Yes</option><option value="No">No</option></td>';
