<page size="A4">
	<div style="font-size: 13px;">
		<div class="print-header">
			...
			<img src="{{ App\Closet\MyHTML::getImageData('images/logos/moh_logo.jpeg') }}" class="stamp" height="200" >
			@else
				@if($result_obj['ref_lab'] == 2898)
				<img src="{{ App\Closet\MyHTML::getImageData('images/logos/logo_'.$result_obj['ref_lab'].'.png') }}" class="stamp img-responsive" width="">
				@else
				<img src="{{ App\Closet\MyHTML::getImageData('images/logos/logo_'.$result_obj['ref_lab'].'.png') }}" class="stamp img-responsive" width="">
				@endif
			@endif
					...
					<div class="print-sect" style = "border-top: 1px solid #a9a6a6;">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td  width="15%" class="print-val" style="padding-top: 10px;"><?=$result_obj['passport_number']?></td>

								<td  width="15%" align="right" style="padding-top: 10px;"><b>
								<?php if(!empty($result_obj['date_of_birth'])){?>
								DOB<?php }else{ ?>
									Age
									<?php }?>
								</b>:</td>
								<td  width="35%" class="print-val" style="padding-top: 10px;">

									<?php if(!empty($result_obj['date_of_birth'])){
										//echo $result_obj['date_of_birth'];
										echo date("d M Y", strtotime($result_obj['date_of_birth']));
									}else{
										echo $result_obj['age_years'];
									}?>
							</td>
					...
					<tr>
						<td width="50%" align="left" style="padding-left:20px;">
							...
							<div style="margin-top:4px;">
								<img src="{{ App\Closet\MyHTML::getImageData('images/lab_'.$result_obj['ref_lab'].'.png') }}" class="stamp" >
							...
							<td width="20%">
								<span><br>
									<img src="{{ App\Closet\MyHTML::getImageData('images/signatures/lab_'.$result_obj['ref_lab'].'.png') }}" class="manager img-responsive" >
									<br>
