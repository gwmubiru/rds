        ...
        <div style="font-size: 21px; border: 1px solid #a9a6a6; padding-top:5px; padding-right:5px; padding-left:5px;">
                <div class="center">
                        <div class="print-header-moh" style="text-align:center">
                                ...
                                <td align="center" style="padding-right: 100px;"><b>COVID-19 Test Certificate</b></td>
                        </div>

                        <tr>
                                <td align="left" style="padding-top: 10px;">Result Number:</td>
                                <td class="print-val" style="padding-top: 10px; padding-left: 5px;">
                                        <!-- <small style="color:red;">MoH-{{$data['patient_id']}}</small> -->
                                        <small style="color:red;">{{$data['patient_id']}}</small>
                                </tr>
                        </div>
                        ...
                        <div style="width:100%;">
                                ...
                                <p style="text-align: center">This is to certify that <b>{{$data['case_name']}}</b>,{{$data['age_years']}} years, {{$data['sex']}}, ID Number <b> @if($data['passport_number'] != "") {{$data['passport_number']}} @else - @endif </b>tested <b>{{$data['result']}}</b> for Covid-19 on
                                        <b>{{date ("M-d-Y",strtotime($data['test_date'])) }}</b> following a laboratory test performed at<b> {{$data['ref_lab_name']}},Uganda. </b><br>

                                        <i style="color:gray;"><b>This certificate is not a guarantee against future infections. Observe hygiene and always wear a face mask while in public.</b></i><br><br>
                                        ...
                                        <div class="qrcode-container">
                                                <div class="qrcode" id="qrcode">
                                                        <?php
                                                        $url = 'moblabs.cphluganda.org/validator/';
                                                        $result_id = Crypt::encrypt($data['result_id']);
							$result = $data['result'];
