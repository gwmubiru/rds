<page size="A4" style="font-family: Arial, Helvetica, sans-serif">
	...
	<div style="font-size: 13px;">
		<div class="print-header">
			...
			@else
				...
				@elseif($result_obj['ref_lab'] == 2898)
				<img src="{{ MyHTML::getImageData('images/logos/logo_'.$result_obj['ref_lab'].'.png') }}" class="stamp img-responsive" width="">
				@else
				<img src="{{ MyHTML::getImageData('images/logos/logo_'.$result_obj['ref_lab'].'.png') }}" class="stamp img-responsive" width="">
				@endif
			...
			<div class="print-header-moh">
				...
				@if($result_obj['ref_lab'] != 2898 && $result_obj['ref_lab'] != 2901 && $result_obj['ref_lab'] != 2904 && $result_obj['ref_lab'] != 2905 && $result_obj['ref_lab'] != 2906 && $result_obj['ref_lab'] != 2895 && $result_obj['ref_lab'] != 2919 && $result_obj['ref_lab'] != 2920)
				<br>
				{{ $result_obj['results']['lab'] }}<br>
				@endif
			</div>
			<br>
			<p style="text-align:center;">COVID-19 TEST RESULTS<br>
		</div>
		...
		<div class="row" style="margin-top: 10px;">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							...
							<tr>
								...
								<td  width="15%" class="print-val" style="padding-top: 14px; padding-left: 5px;"><?=$result_obj['results']['collection_date']?></td>
							</tr>
							<tr>
				...
				<div style="width:100%;">
					<div class="print-sect" style = "padding-top:5px;">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							@for($i = 0; $i < 1; $i++)
							<tr>
								<td class="print-vald" width="15%"><?=$result_obj['results']['collection_date']?>
									@if($result_obj['results']['specimen_collection_time'] != '12:00:00 am')
								<br>
								<?=$result_obj['results']['specimen_collection_time']?>
								@endif
								</td>
								<td class="print-vald" width="15%"><?=$result_obj['results']['test_date']?>
									@if($result_obj['results']['test_time'] != '12:00:00 am')
									<br><?=$result_obj['results']['test_time']?>
									@endif
								</td>
								...
								<td class="print-vald" width="45%"><span id="result" class="<?=strtolower($result_obj['results']['result'])?>"><?=strtoupper($result_obj['results']['result'])?></span></td>
			...
			<div class="row" style = "border-top: 8px solid #a9a6a6; margin-top:10px;">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<br>
					<small><i>Printed by:....<?=$result_obj['printed_by']?>...................Print Date:...<?php echo date("D / d / M / Y"); ?>................Printed <?php echo $result_obj['download_counter']; ?> time(s).....</i></samll>
